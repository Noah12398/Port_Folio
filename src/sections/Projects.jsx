...
function Projects() {
  ...
  const projects = [
    ...
    },
    {
      ...
      title: "Recipe Maker",
      description:
        "A Firebase-powered recipe manager where users can add, view, and delete cooking recipes.",
    ...
    },
    {
      ...
      title: "Car Game",
      description:
        "A 2D car racing game developed using LibGDX with exciting gameplay and graphics.",
    ...
    },
    {
      ...
      description:
        "A smart financial assistant that analyzes user expenses and provides insights using AI.",
    ...
    },
    {
      ...
      title: "Notes",
      description:
        "A notes-taking app with CRUD functionality and local storage integration.",
    ...
    },
    {
      ...
      title: "Translator",
      description:
        "A simple translation app that helps users translate text between languages.",
  ...
  return (
    <section
      className="py-20 px-6 bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 relative overflow-hidden"
      id="projects"
    >
        ...
        <div className="embla" ref={emblaRef}>
          <div className="embla__container flex">
            {projects.map((project, index) => (
              <div
                key={project.id}
                className="embla__slide flex-none w-96 mr-6"
                onMouseEnter={handleMouseEnter}
                onMouseLeave={handleMouseLeave}
              >
                <div className="group cursor-pointer h-full">
                  <div className="bg-white/10 backdrop-blur-lg rounded-2xl border border-white/20 hover:border-white/40 transition-all duration-500 hover:scale-105 hover:shadow-2xl hover:shadow-purple-500/25 overflow-hidden h-full">
                    {/* Project Image */}
                    <div className="relative overflow-hidden">
                      ...
                      />
                      <div
                        className={`absolute inset-0 bg-gradient-to-t ${project.gradient} opacity-0 group-hover:opacity-80 transition-all duration-500`}
                      ></div>
