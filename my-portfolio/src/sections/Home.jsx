...
function Home() {
  ...
  return (
    <section
      id="home"
      className="relative min-h-screen flex flex-col justify-center items-center bg-gradient-to-br from-black via-gray-950 to-indigo-950 text-white px-6 text-center overflow-hidden"
    >
      ...
      {/* Main content */}
      <div className={`relative z-10 max-w-5xl mx-auto transition-all duration-1000 ${isLoaded ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
        ...
        <p className="text-lg sm:text-xl text-gray-300 mb-12 max-w-3xl mx-auto leading-relaxed font-light">
          Transforming complex ideas into elegant, scalable solutions. I create digital experiences that merge 
          <span className="text-purple-400 font-medium"> aesthetic excellence</span> with 
          <span className="text-indigo-400 font-medium"> technical precision</span>, 
        ...
        {/* Professional stats */}
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-8 mb-16 max-w-2xl mx-auto">
          {[
            ...
            <div key={index} className="text-center group">
              <div className="text-2xl sm:text-3xl font-bold text-purple-400 mb-1 group-hover:scale-110 transition-transform duration-300">
                {stat.number}
              </div>
      ...
      <div className="absolute inset-0 bg-[linear-gradient(45deg,transparent_24%,rgba(255,255,255,.01)_25%,rgba(255,255,255,.01)_26%,transparent_27%)] bg-[length:80px_80px] opacity-50"></div>
